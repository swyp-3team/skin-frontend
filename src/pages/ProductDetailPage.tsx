...
import GlassOverlayHeader from '../components/headers/GlassOverlayHeader'
...
function ProductDetailPage() {
  ...
  const formattedPriceDate = formatPriceAsOf(product.createdDate)
  ...
  return (
    ...
    >
      <section className="relative isolate bg-neutral-0 pb-24">
        <div className="relative isolate z-0 h-[640px] overflow-hidden">
          <SafeImage
            alt={product.name}
